...
return new class extends Migration
{
    ...
    {
        $menuIds = DB::table('portal_menus')->whereIn('slug', ['hiring-workspace', 'jobs', 'job-postings', 'create-job'])->pluck('id');
    ...
    {
        // Preserve menu visibility; subscription rules may be customized after deployment.
    }
};
