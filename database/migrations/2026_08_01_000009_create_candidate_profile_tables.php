...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('candidate_profiles', function (Blueprint $table) {
            ...
            $table->boolean('job_alerts_allowed')->default(true);
        ...
        Schema::create('candidate_experiences', function (Blueprint $table) {
            ...
            $table->foreignId('work_mode_id')->nullable()->constrained()->nullOnDelete();
            $table->foreignId('country_id')->nullable()->constrained()->nullOnDelete();
            $table->string('city')->nullable();
        ...
        Schema::create('candidate_profile_employment_type', function (Blueprint $table) {
            $table->id();
            $table->foreignId('candidate_profile_id')->constrained()->cascadeOnDelete();
            $table->foreignId('employment_type_id')->constrained()->cascadeOnDelete();
            $table->unique(['candidate_profile_id', 'employment_type_id']);
        });
        Schema::create('candidate_profile_work_mode', function (Blueprint $table) {
            $table->id();
            $table->foreignId('candidate_profile_id')->constrained()->cascadeOnDelete();
            $table->foreignId('work_mode_id')->constrained()->cascadeOnDelete();
            $table->unique(['candidate_profile_id', 'work_mode_id']);
        });
    }

    public function down(): void
    {
        foreach (['candidate_profile_work_mode', 'candidate_profile_employment_type', 'candidate_profile_language', 'candidate_profile_skill', 'candidate_experiences', 'candidate_educations', 'candidate_profiles', 'proficiency_levels', 'study_modes', 'work_modes', 'employment_types', 'skills', 'languages', 'countries'] as $name) {
