...
@section('content')
<div class="dashboard-heading mb-4"><div><span class="dashboard-eyebrow">ACCOUNT</span><h1>Account settings</h1><p>Manage your {{ $companyProfile->display_name }} experience.</p></div></div>
