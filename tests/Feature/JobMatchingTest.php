...
class JobMatchingTest extends TestCase {
 ...
 public function test_tuition_jobs_are_available_to_applicants_and_recruiters():void{$talent=User::where('email','talent@example.com')->firstOrFail();$this->actingAs($talent)->get(route('talent.job-preferences.edit'))->assertOk()->assertSee('Tutoring &amp; Tuition Services',false)->assertSee('Home Tuition')->assertSee('Home Tutor')->assertSee('Online Tuition')->assertSee('Online Tutor')->assertSee('Tuition Centers');}
