...
Route::middleware(['auth', 'category:recruiter', 'module:recruitment'])->prefix('recruiter')->name('recruiter.')->group(function () {
    ...
    Route::get('/profile/contact-detail', [RecruiterProfileController::class, 'contact'])->name('profile.contact');
    Route::put('/profile/contact-detail', [RecruiterProfileController::class, 'updateContact'])->name('profile.contact.update');
    Route::get('/profile/organisations', [RecruiterProfileController::class, 'organizations'])->name('profile.organizations');
    Route::put('/profile', [RecruiterProfileController::class, 'updateContact'])->name('profile.update');
    ...
    Route::get('/job-postings', [JobPostingController::class, 'index'])->middleware('menu:job-postings,view')->name('job-postings.index');
    Route::get('/job-postings/create', [JobPostingController::class, 'create'])->middleware('menu:create-job,create')->name('job-postings.create');
    Route::post('/job-postings', [JobPostingController::class, 'store'])->middleware('menu:create-job,create')->name('job-postings.store');
    Route::get('/job-postings/{jobPosting}/edit', [JobPostingController::class, 'edit'])->middleware('menu:job-postings,update')->name('job-postings.edit');
    Route::put('/job-postings/{jobPosting}', [JobPostingController::class, 'update'])->middleware('menu:job-postings,update')->name('job-postings.update');
    Route::delete('/job-postings/{jobPosting}', [JobPostingController::class, 'destroy'])->middleware('menu:job-postings,delete')->name('job-postings.destroy');
